...
export interface SrPreprocessParams {
  nc_folder: string
  output_base: string
...
function hasStage1(p: SrPreprocessParams): boolean {
  return !!p.dyn_vars?.length
}

function hasStage2(p: SrPreprocessParams): boolean {
 ...
 * - undefined → 未回答，未通过
 */
function hasStage2_5(p: SrPreprocessParams): boolean {
...
function hasStage3(p: SrPreprocessParams): boolean {
...
function buildStage1Prompt(inspectResult: any, params: SrPreprocessParams): SrPreprocessStageResult {
...
function buildStage2Prompt(inspectResult: any, params: SrPreprocessParams): SrPreprocessStageResult {
  return {
...
function buildStage2_5Prompt(inspectResult: any, params: SrPreprocessParams): SrPreprocessStageResult {
...
function buildStage3Prompt(inspectResult: any, params: SrPreprocessParams): SrPreprocessStageResult {
